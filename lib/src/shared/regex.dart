class RegexHelper {
  ...
  static String queryPath = '\\/[-~+%_a-zA-Z0-9.]+';
  static String searchString = '\\?[-+=&;%@_.a-zA-Z0-9]+';
  static String queryHash = '#[-_a-zA-Z0-9]+';

  static String link = '\\b($protocol|$protocol$www|$www)$domain($queryPath)*(\\/?$searchString)?($queryHash)?\\b';
